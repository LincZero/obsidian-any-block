...
- linux
	- You can install the program using the apt package in the terminal by executing the following command:
	  ```shell
...
- macOS
	- Go to the official Python site and navigate to the latest version. As of this writing, it is' 3.10.6 '.
	- Download the binaries for your platform. Execute binary.
	- On a Mac, this will be done by default in the dmg installer.
